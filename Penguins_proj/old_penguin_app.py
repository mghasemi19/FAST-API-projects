...
# KNN model fit on penguins dataset -- return the model and preprocessing function
...
async def lifespan(app: FastAPI):
    # Set up the ML model here and store it in the ml_models dictionary
